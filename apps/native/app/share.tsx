      ...
      <StyledSafeAreaView className="flex-1 items-center justify-center bg-background px-8">
        <View className="items-center gap-4">
          <View className="size-16 rounded-full bg-success/20 items-center justify-center">
            <StyledIonicons name="checkmark" size={32} className="text-success" />
          </View>
    ...
    return (
      <StyledSafeAreaView className="flex-1 items-center justify-center bg-background px-8">
        <View className="items-center gap-4">
          ...
          <Text className="text-xl font-medium text-foreground">Failed to send</Text>
          <Text className="text-sm text-muted text-center">{sendError.message}</Text>
        </View>
      </StyledSafeAreaView>
    );
  }
